...
$(document).ready(function() {
  ...
  $( "#clickedrow").find('tr').click(function() {
    rowSelected = ($(this).index());
    $('#redpanel').html(arrayOfRedRiskInformation[rowSelected]);
//    alert(arrayOfRedRiskInformation[row] );
    $('#amberpanel').html(arrayOfAmberRiskInformation[rowSelected]);
    $('#greenpanel').html(arrayOfGreenRiskInformation[rowSelected]);
    $('#bluepanel').html(arrayOfBlueRiskInformation[rowSelected]);
  ...
  $('#redselect').click(function(){
    ...
    //  alert('undefined');
      ...
      var rowToChange = $('#clickedrow').find('tr');
      rowToChange.eq(rowSelected).css('backgroundColor', red);
    }
  });

  $('#amberselect').click(function(){
    if(rowSelected==undefined){
    //  alert('undefined');
      return;
    } else {
      var rowToChange = $('#clickedrow').find('tr');
      rowToChange.eq(rowSelected).css('backgroundColor', amber);
    }
  });
  ...
  //    alert('undefined');
      ...
      var rowToChange = $('#clickedrow').find('tr');
      rowToChange.eq(rowSelected).css('backgroundColor', green);
    }
  });
  ...
  //    alert('undefined');
      ...
      var rowToChange = $('#clickedrow').find('tr');
      rowToChange.eq(rowSelected).css('backgroundColor', blue);
    }
  });
});
